...
![AI‑Assisted Development](https://img.shields.io/badge/-AI%20Assisted%20Development-000000?logo=openai&logoColor=white) (Cursor, Copilot, Roo Code)

---

## 🧠 My Vibe

I'm a problem‑solver who thrives on turning complex challenges into elegant, scalable solutions. I believe in:
- **Clean architecture** that stands the test of time
- **AI‑augmented development** to multiply velocity
- **Continuous learning** – mastering new stacks under pressure
- **Business‑aware engineering** – code that drives real impact
